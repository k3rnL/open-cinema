...
MANIFEST_PATH = Path(__file__).parents[1] / "deployment" / "release-manifest.yml"
...
def test_experimental_release_manifest_covers_the_coordinated_boundary() -> None:
    ...
    assert manifest["rollback"]["identity"] == "assigned-at-deployment"
